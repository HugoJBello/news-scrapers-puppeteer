...
export class XatakaContentScraper extends ContentScraper {
    public newspaper: string
    public scraperId: string
    public excludedParagraphsEqual: string[] = [' ', '  ', ' \n', '  \n']
    public excludedParagraphsIncluding: string[] = ['Si eliges beneficiarte de la oferta de pago','Si ya te beneficias de la oferta', 'Si te suscribes a esta oferta','Si eliges acceder al sitio de forma gratuita',
    'Consulta las condiciones de la oferta', 'Se colocarán y leerán cookies', 'Puedes retirar tu consentimiento']
    public mustStartWith = "https://www.xataka.com/"
    ...
    async extractFigures():Promise<any> {
        ...
        const figs = await this.page.$$("picture")
        for (let fig of figs){
